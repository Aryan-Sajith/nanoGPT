...
duplicate_story_index = 799_634
total_stories = 1_060_000
duplicable_total = total_stories - 1 # Calculate the total number of stories that can be duplicated
percent_duplicates = 0.75
num_duplicates = int(percent_duplicates * duplicable_total)

# Randomly pick (num_duplicates) stories from 0 - 530_000 excluding duplicate_story_index as it's the original
story_indices = list(range(0, total_stories))  
if duplicate_story_index in story_indices:
...
baseline_training_txt = "data/tinyStories/sizes/50-percent-size/fifty-percent-train.txt"
output_training_txt = "data/tinyStories/sizes/50-percent-size/dup-75-percent/size50-dup75.txt"
story_separator = "\n---\n"
